...
import commons
import modulos
from modulos import CamadaNorm

#from lib.infer_pack import commons
#from lib.infer_pack import modulos
#from lib.infer_pack.modulos import CamadaNorm
    ...
    def __init__(
        ...
        **kwargs
        ...
        for i in range(self.n_layers):
            ...
            self.norm_layers_1.append(CamadaNorm(hidden_channels))
            ...
            self.norm_layers_2.append(CamadaNorm(hidden_channels))
...
class Decoder(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        for i in range(self.n_layers):
            ...
            self.norm_layers_0.append(CamadaNorm(hidden_channels))
    ...
    def forward(self, x, x_mask, h, h_mask):
        """
        x: entrada do decodificador
        h: saída do codificador
        """
